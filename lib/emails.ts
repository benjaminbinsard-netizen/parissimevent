...
Parissim Event · Paris · Saint-Tropez · Côte d'Azur
</td></tr></table>
...
export function clientConfirmationEmail(lead: LeadData): {
  ...
  const subject = "Votre demande a bien été reçue — Parissim Event";
  const html = shell(`
${header()}
<tr><td style="padding:40px 44px;font-family:Arial,Helvetica,sans-serif;color:${TEXT};">
  ...
  <p style="margin:26px 0 0;font-family:Georgia,serif;font-size:15px;color:${TEXT};">
    ...
    <span style="color:${BRONZE_LIGHT};font-style:italic;">La Parissim Event</span>
  </p>
</td></tr>`);
  return { subject, html };
}
